...
<html lang="en">
  ...
  <nav class="navbar navbar-expand-md navbar-light py-3">
    <div class="container">
    <a class="navbar-brand"><img src="../assets/images/award.png" class="img-fluid" width="48px">
    Mirada perfecta</a>
      ...
      <ul class="navbar-nav ml-auto">
          ...
          <li class="nav-item">
            <a class="nav-link" href="../Historial_clinico/Historial_clinicio.php">Historial </a>
          </li>
          <li class="nav-item">
          ...
          <div class="widget-menu-items mt-sm-5 mt-4">
            ...
            <nav class="navbar p-0">
              <ul class="navbar-nav">
                ...
                <li class="nav-item">
                  <a class="nav-link" href="Productospac.php">Productos y servicios</a>
                </li>
