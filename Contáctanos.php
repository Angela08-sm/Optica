...
<html lang="en">
  <head>
    ...
    <title>Medpill a Medical Category Responsive Web Template - Contact : W3Layouts</title>
    ...
    <a class="navbar-brand" href="#index.html">
      ...
      <div class="collapse navbar-collapse" id="navbarSupportedContent">
        <ul class="navbar-nav ml-auto">
          ...
          <li class="nav-item">
            <a class="nav-link" href="Contáctanos.html">Productos</a>
          </li>
          <li class="nav-item">
            <a class="nav-link" href="Citas.html">Citas</a>
          </li>
          <li class="nav-item">
            <a class="nav-link" href="Mas.html">Más</a>
          </li>
        </ul>
      </div>
        ...
        <div class="container py-lg-3">
          <div class="row footer-top-28">
            ...
            <div class="col-lg-3 col-md-6 col-sm-8 footer-list-28 mt-sm-5 mt-4">
              <h6 class="footer-title-28">Horario</h6>
