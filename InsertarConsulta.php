      ...
      <div class="modal-body">
        <div class="modal__content">
          ...
          <div class="widget-social-icons mt-sm-5 mt-4">
            <h5 class="widget-title">Insertar consulta</h5>
...
<section class="w3l-about-breadcrumb">
  ...
  <h2 class="tituloinsert">INSERTAR CONSULTA</h2>
  <br>
  <form action="" method="post">
    <p> ID_USUARIO: 
        <input type="text" name="TXTIDUSU" required><p>
   <br> </p>
    <p> ID_TRATAMIENTO: 
        <input type="text" name="TXTIDTRAT" required><p>
    <br></p>
    <p> ID_PRODUCTO: 
        <input type="text" name="TXTIDPRO" required><p>
    <br></p>
    <p> FECHA: 
        <input type="text" name="TXTFECHA" required><p>
    <br></p>
    <p> HORA: 
        <input type="text" name="TXTHORA" required><p>
    <br></p>
    <p>DIAGNOSTICO: 
        <input type="text" name="TXTDIAG" required><p>
    <br></p>
    <p>  RECOMENDACIONES: 
        <input type="text" name="TXTRECOM" required><p>
    <br></p>
